...
public class BufferedFileCopy {
    ...
    public static void main(String[] args) {
        String source = "src/ioStreams/sample_large.txt";
        String destBuffered = "src/ioStreams/copy_buffered.txt";
        String destUnbuffered = "src/ioStreams/copy_unbuffered.txt";
